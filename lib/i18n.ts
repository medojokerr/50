export const translations = {
  ...
  ar: {
    ...
    faqA2: "جميع الباقات تسلم فيديو كامل جاهز للاستخدام. الباقات الأساسية تشمل فيديوهات عالية الجودة مع تعليق صوتي احترافي. الباقات المميزة تضي�� شخصيات ناطقة. نحن نسلم الفيديو النهائي - لا تحتاج لأي شيء إضافي.",
