    ...
    >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10 max-w-7xl mx-auto relative z-10">
            ...
            <Card className="group bg-gradient-to-br from-purple-600 via-pink-600 to-purple-700 text-white border-none shadow-2xl hover:shadow-purple-500/30 transition-all duration-500 transform hover:scale-105 hover:-translate-y-3 overflow-hidden relative">
              ...
              <CardContent className="p-6 relative z-10">
                ...
                <Link href={`https://wa.me/${t.whatsappNumber}?text=${encodeURIComponent(locale === "ar" ? "أريد مشاهدة مثال الشخصيات ا��ناطقة" : "I want to see the speaking characters example")}`} target="_blank" rel="noopener noreferrer">
        ...
        <div className="container mx-auto px-6 text-center relative z-10">
          <div className="max-w-4xl mx-auto">
            ...
            <h2 className="text-5xl md:text-6xl font-extrabold text-white mb-6">
              {locale === "ar" ? "جاهز لإ����اء فيديوك الاحترا��ي؟" : "Ready to Create Your Professional Video?"}
            </h2>
      ...
      <div className="fixed bottom-6 right-6 z-50">
        <div className="relative">
          ...
          <Link href={`https://wa.me/${t.whatsappNumber}?text=${encodeURIComponent(locale === "ar" ? "🚀 مرحباً! ��ريد الاستفادة من العرض الح��ري المحدود!" : "🚀 Hello! I want to take advantage of the exclusive limited offer!")}`} target="_blank" rel="noopener noreferrer">
